...
public class ShortenController {
    ...
    public String getUrl(HttpServletRequest request, HttpServletResponse response, @RequestBody String url, Model model) {

        String token = request.getHeader("token");
        Map payloads = JWTUtils.getPayloads(token);
        String userName = (String) payloads.get("name");
